...
namespace Regression_UAT_Environment.Tests
{
    public class EntitlementTests : IDisposable
    {
        ...
        private SetDefaultCustomer SetDefault;
        ...
        public void Test776077_Delete_entitlement_for_one_user_if_they_not_access_to_any_product()
        {
            ...
            Assert.Equal(expected: HttpStatusCode.NotFound, responseDeleteUserWithProductContinue.Item1);
        ...
        public void Setup_1st_ProductEnvironment_To_Create_User_with_Product()
        {
            ...
            string type = "API";
            var productDetails1 = ProductFactory.createProductList(productId1, productName1, productCode1, productIconColor, productLineName, solutionFamilyId, type);
        ...
        public void Setup_2nd_ProductEnvironment_To_Create_User_with_Product()
        {
            ...
            string type = "API";
            var productDetails2 = ProductFactory.createProductList(productId2, productName2, productCode2, productIconColor, productLineName, solutionFamilyId, type);
        ...
        public void Test_set_default()
        {
            ...
            string customerName2 = $"Customer_{StringUtils.RandomString(10)}";
            var customerDetails2 = CustomerFactory.createCustomer(customerId2, customerName2, true); 
            Tuple<HttpStatusCode, String> responseCreateCustomer2 = CustomerAPIs.Create_Customers_Details(customerDetails2);
            Assert.Equal(expected: HttpStatusCode.OK, responseCreateCustomer2.Item1);

            //Associate Customer2 And Product Environment(1)
            associateCustomerDetails2 = AssociateFactory.createAssociate(customerId2, true);
            Tuple<HttpStatusCode, String> responseAssociateCustomer2 = EnvironmentAPIs.Associate_Customer_With_Product_Environment(productEnvironmentId1, associateCustomerDetails2);
            Assert.Equal(expected: HttpStatusCode.OK, responseAssociateCustomer2.Item1);

            //Create User with customer1
            string userName = StringUtils.RandomString(10);
            userWithProductDetails1 = EntitlementFactory.createEntitlement(productId1, customerId, $"email_{userName}@gmail.com", userName, false);
            Tuple<HttpStatusCode, String> responseCreateuserWithProduct = EntitlementAPIs.Create_Entitlements_For_The_Product_of_Customer(userWithProductDetails1);
            Assert.Equal(expected: HttpStatusCode.OK, responseCreateuserWithProduct.Item1);

            //Create User with customer2
            string userName2 = StringUtils.RandomString(10);
            userWithProductDetails2 = EntitlementFactory.createEntitlement(productId1, customerId2, $"email_{userName}@gmail.com", userName2, false);
            Tuple<HttpStatusCode, String> responseCreateuserWithProduct2 = EntitlementAPIs.Create_Entitlements_For_The_Product_of_Customer(userWithProductDetails2);
            Assert.Equal(expected: HttpStatusCode.OK, responseCreateuserWithProduct2.Item1);
            ...
            Assert.Equal(expected: HttpStatusCode.OK, responseGetUser.Item1);
            Assert.Equal(expected: customerId, JObject.Parse(responseGetUser.Item2)["defaultCustomerId"].ToString());

            //Set customer2 is the default customer of User
            SetDefault = EntitlementFactory.setDefaultCustomer($"email_{userName}@gmail.com", customerId2);
            Tuple<HttpStatusCode, String> responseSetDefault = EntitlementAPIs.Set_DefaultCustomer_for_User(SetDefault);
            Assert.Equal(expected: HttpStatusCode.OK, responseSetDefault.Item1);

            //Get User and verify the customer2 is the default after we set it as the default customer
            Tuple<HttpStatusCode, String> responseGetUser2 = UserAPIs.Get_User_By_Email($"email_{userName}@gmail.com");
            logger.WriteLine("Response Get User with Invalid Email: " + responseGetUser2);
            Assert.Equal(expected: HttpStatusCode.OK, responseGetUser2.Item1);
            Assert.Equal(expected: customerId2, JObject.Parse(responseGetUser2.Item2)["defaultCustomerId"].ToString());
        }
    }
}