...
namespace Regression_UAT_Environment.Tests
{
    public class UserTests : IDisposable
    {
        ...
        public void Test776995_Get_User_with_blank_Email()
        {
            ...
            Assert.Equal(expected: HttpStatusCode.NotImplemented, responseGetUser.Item1);
        }
        ...
        public void Test777005_Update_User_Details_With_Valid_GUID_Entitlement_And_New_Email_Not_In_Entitlement_B2C()
        {
            ...
            logger.WriteLine("Response Update User with Valid ID and Email not in EnvitlementB2C: " + responseUpdateUser);
        ...
        public void Test777070_Update_User_Details_With_Valid_GUID_Entitlement_B2C_And_New_Email_Entitlement()
        {
            ...
            //Create User with product
            List<string> listUserEmail = new List<string> { $"email{StringUtils.RandomString(10)}@gmail.com", $"email{StringUtils.RandomString(10)}@gmail.com" };
            List<string> listDisplayName = new List<string> { $"email{StringUtils.RandomString(10)}@gmail.com", $"email{StringUtils.RandomString(10)}@gmail.com" };
        ...
        public void Test778939_Update_User_Details_with_Blank_GUID_Entitlement_and_New_Email_not_In_Entitlement_B2C()
        {
            ...
            //Update User Details
            var userDetails = UserFactory.createUser($"new{userEmail}");
